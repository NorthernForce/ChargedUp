...
public class RedLeft extends SequentialCommandGroup {
   ...
   * @throws IOException */
  public RedLeft(int numPieces) throws IOException {
    ...
    if (numPieces > 1)
    {
      addCommands(
        new WaitCommand(2),
        new PositionWithTarget(FieldConstants.RED_GAME_PIECE_AUTO_LOCATIONS[0].toTranslation2d(), AnglesAndDistances.BACKWARD_FLOOR_CUBE.getFirst(),
        ...
        new RetractArm(),
        new SetArmAngle(Rotation2d.fromDegrees(90)),
        new DriveAlongPath(Constants.Path.FORWARD_PIECE_LEFT_TO_RED_LEFT),
    ...
    if (numPieces > 2)
    {
      addCommands(
        ...
        new DriveAlongPath("Red1ToPiece2"),
        new PositionWithTarget(FieldConstants.RED_GAME_PIECE_AUTO_LOCATIONS[1].toTranslation2d(), AnglesAndDistances.LOW_CUBE.getFirst(),
        ...
        new SetArmAngle(Rotation2d.fromDegrees(90)),
        new DriveAlongPath("Piece2ToRed1"),
        new PositionWithTarget(FieldConstants.RED_FLOOR_PLACEMENT_LOCATIONS[1].toTranslation2d(), AnglesAndDistances.LOW_CUBE.getFirst(),
          AnglesAndDistances.LOW_CUBE.getSecond().plus(Rotation2d.fromDegrees(20)),
          WristConstants.LOW_CUBE_PLACEMENT_ANGLE, false),
        new ParallelDeadlineGroup(
          new WaitCommand(0.5),
