...
public class RedRight extends SequentialCommandGroup {
   ...
   * @throws IOException */
  public RedRight(int numPieces) throws IOException {
    ...
    if (numPieces > 2)
    {
      addCommands(
        ...
        new DriveAlongPath("Red3ToPiece3"),
        new PositionWithTarget(FieldConstants.RED_GAME_PIECE_AUTO_LOCATIONS[2].toTranslation2d(), AnglesAndDistances.LOW_CUBE.getFirst(),
          AnglesAndDistances.LOW_CUBE.getSecond().plus(Rotation2d.fromDegrees(20)),
          WristConstants.LOW_CUBE_PLACEMENT_ANGLE, false),
        new ParallelDeadlineGroup(
          new WaitCommand(1),
        ...
        new SetArmAngle(Rotation2d.fromDegrees(90)),
        new DriveAlongPath("Piece3ToRed3"),
        new PositionWithTarget(FieldConstants.RED_FLOOR_PLACEMENT_LOCATIONS[7].toTranslation2d(), AnglesAndDistances.LOW_CUBE.getFirst(),
          AnglesAndDistances.LOW_CUBE.getSecond().plus(Rotation2d.fromDegrees(20)),
          WristConstants.LOW_CUBE_PLACEMENT_ANGLE, false),
        new ParallelDeadlineGroup(
          new WaitCommand(0.5),
