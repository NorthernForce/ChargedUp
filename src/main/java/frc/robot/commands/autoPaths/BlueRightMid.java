...
public class BlueRightMid extends SequentialCommandGroup {
  ...
  public BlueRightMid() {
    ...
    addCommands(
      new ManipulateCube(),
      new FoldWristBack(),
      new PositionWithTarget(FieldConstants.BLUE_CUBE_PLACEMENT_LOCATIONS[0].toTranslation2d(), Constants.AnglesAndDistances.MEDIUM_CUBE.getFirst(), Constants.AnglesAndDistances.MEDIUM_CUBE.getSecond(), Rotation2d.fromDegrees(0), false),
